...
export default function ManajemenPortofolioPage() {
  ...
  const handleDelete = async (id: string) => {
    const confirmDelete = await Swal.fire({
      ...
      text: "Data portofolio ini tidak bisa dikembalikan!",
      icon: 'warning',
      ...
      <div className="bg-white rounded-[1.5rem] border border-gray-200 shadow-sm overflow-hidden">
        ...
        <div className="p-6 border-b border-gray-100 flex flex-col sm:flex-row justify-between items-center gap-4">
          <div className="flex items-center gap-2 text-sm text-gray-600 font-medium">
            <span>Show</span>
            <select aria-label="Tampilkan entri" className="border border-gray-300 rounded-lg px-3 py-1.5 focus:ring-2 focus:ring-red-500 bg-white outline-none">
              <option>10</option>
              <option>25</option>
              <option>50</option>
            </select>
                ...
                <tr>
                  <td colSpan={3} className="py-20 text-center">
                    <div className="flex flex-col items-center justify-center">
                      ...
                      <p className="text-gray-500">Kami tidak menemukan portofolio dengan kata kunci <span className="font-bold text-gray-700">&quot;{searchTerm}&quot;</span>.</p>
                    </div>
                  </td>
                </tr>
              ) : (
