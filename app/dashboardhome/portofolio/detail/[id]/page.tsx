    ...
    <div className="min-h-screen p-6 sm:p-10 font-sans">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4">
        <div>
          ...
          <p className="text-gray-500 font-medium ml-12">Melihat informasi lengkap dari project yang dipilih.</p>
        </div>
      </div>
      ...
      <div className="bg-white rounded-[1.5rem] border border-gray-200 shadow-sm overflow-hidden p-6 sm:p-10 max-w-4xl relative">
        ...
        {isLoading ? (
          <div className="py-20 flex flex-col items-center justify-center">
             <div className="inline-block animate-spin w-8 h-8 border-4 border-red-600 border-t-transparent rounded-full mb-4"></div>
             <p className="text-gray-500 font-bold">Sedang memuat detail portofolio...</p>
          </div>
        ) : portofolioDetail ? (
          ...
          <div className="space-y-8">
            <div className="border-b border-gray-100 pb-6">
              <div className="flex flex-wrap items-center gap-3 mb-4">
                <span className="px-3 py-1 bg-red-50 text-red-600 rounded-lg text-xs font-black tracking-wider uppercase border border-red-100">
              ...
              {portofolioDetail.project_url && (
                <a 
                  ...
                  className="inline-flex items-center gap-2 text-white bg-red-600 hover:bg-red-700 font-bold px-5 py-2.5 rounded-xl transition-colors shadow-md shadow-red-100"
                >
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2.5} stroke="currentColor" className="w-5 h-5">
            ...
            {imageUrl ? (
              ...
              <div className="w-full h-40 bg-gray-50 border border-gray-200 rounded-2xl flex items-center justify-center text-gray-400 font-medium">
              ...
              <div className="prose max-w-none text-gray-900 leading-relaxed font-medium">
                <div 
                  dangerouslySetInnerHTML={{ 
                    __html: portofolioDetail.description || portofolioDetail.konten || portofolioDetail.deskripsi 
                  }} 
                />
              </div>
            )}
          ...
          <div className="py-20 text-center">
            <div className="flex flex-col items-center justify-center">
              <div className="bg-red-50 p-6 rounded-full mb-6 border border-red-100 shadow-inner">
                <svg xmlns="http://www.w3.org/2000/svg" className="w-20 h-20 text-red-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
